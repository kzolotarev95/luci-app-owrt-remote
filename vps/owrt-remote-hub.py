...
.brandPanel{{display:grid;grid-template-columns:repeat(2,minmax(0,132px));gap:8px}}.brandPanel .appBanner{{grid-column:1/-1;width:100%;min-width:0}}.brandPanel .links{{grid-column:1/-1;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:0}}.brandPanel .links a{{width:100%;min-width:0}}.nethavenTop{{border-color:rgba(34,211,238,.46);background:linear-gradient(110deg,rgba(14,165,233,.20),rgba(168,85,247,.22),rgba(34,197,94,.14));color:#ecfeff}}.sectionHead{{align-items:center;justify-content:center;flex-direction:column;text-align:center;padding:16px;border:1px solid var(--line);border-radius:8px;background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.045)),var(--panel);box-shadow:0 18px 46px rgba(0,0,0,.20);backdrop-filter:blur(10px)}}.sectionHead h2{{display:inline-flex;align-items:center;justify-content:center;min-height:40px;min-width:220px;margin:0;padding:10px 18px;border:1px solid rgba(34,211,238,.34);border-radius:999px;background:linear-gradient(110deg,rgba(34,211,238,.13),rgba(124,58,237,.24),rgba(236,72,153,.11));box-shadow:inset 0 1px 0 rgba(255,255,255,.10);font-size:20px}}.summary{{justify-content:center}}.card{{text-align:center}}.cardTop{{align-items:center;justify-content:center;flex-direction:column}}.routerMark{{margin:0 auto}}.tagRow,.actions{{justify-content:center}}.name{{white-space:normal}}.metric{{text-align:center}}.metric.span2{{grid-column:1/-1}}
...
.bad{{color:#fecdd3}}
@media(max-width:980px),(pointer:coarse){{body{{height:100dvh;min-height:100dvh;padding:4px;font-size:13px;background-attachment:scroll;overflow:hidden}}.wrap{{gap:5px;height:calc(100dvh - 8px);min-height:0;max-width:none;overflow:hidden}}.top{{flex:0 0 auto;align-items:stretch;flex-direction:column;gap:5px;min-height:0}}.sshTitle{{align-items:flex-start;flex-direction:column;gap:4px}}h1{{font-size:15px}}.chips{{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));width:100%;gap:4px}}.chip{{text-align:center;padding:4px 5px;font-size:10px;overflow:hidden;text-overflow:ellipsis}}.btn{{width:100%;min-width:0;padding:7px 9px}}.termBox{{flex:1 1 auto;height:auto;min-height:0;max-height:none;border-radius:6px}}.bar{{flex:0 0 auto;align-items:stretch;flex-direction:column;gap:5px;padding:5px}}.terminalHint{{display:none}}.badge{{width:100%;justify-content:center;padding:6px 9px;font-size:12px}}.termActions{{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));width:100%;gap:4px}}.miniBtn{{padding:6px 5px;font-size:10px}}#term{{font-size:11.5px;line-height:1.23;padding:8px;min-height:0;overflow-x:hidden}}.mobileInput{{flex:0 0 auto;display:grid;grid-template-columns:1fr 72px 84px;gap:5px;padding:5px}}.mobileInput input{{grid-column:1/-1;padding:9px 10px;font-size:15px}}.mobileInput .pasteBtn,.mobileInput .enterBtn,.mobileInput .sendBtn{{grid-column:auto;padding:9px 7px;font-size:12px}}}}
@supports not (height: 100dvh){{@media(max-width:980px),(pointer:coarse){{body{{height:100svh;min-height:100svh}}.wrap{{height:calc(100svh - 8px)}}}}}}
