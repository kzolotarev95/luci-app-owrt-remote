...
<style>
:root{{color-scheme:light;--bg:#f5f7fb;--panel:#fff;--text:#152033;--muted:#687385;--line:#d9e1ec;--blue:#2563eb;--green:#16a34a;--red:#dc2626;--amber:#d97706;--teal:#0f766e}}
...
.brand{{display:flex;align-items:center;gap:14px}}.logo{{width:54px;height:54px;border-radius:8px;background:var(--teal);color:#fff;display:grid;place-items:center;font-weight:900;font-size:24px;box-shadow:0 14px 34px rgba(15,118,110,.22)}}
h1{{margin:0;font-size:29px;letter-spacing:0}}.muted{{color:var(--muted)}}.top p{{margin:4px 0 0}}.badge{{display:inline-flex;gap:8px;align-items:center;border:1px solid var(--line);background:#fff;border-radius:999px;padding:8px 12px;color:var(--muted);white-space:nowrap}}
...
.cardHead{{display:flex;gap:12px;align-items:flex-start;justify-content:space-between}}.routerIcon{{width:46px;height:46px;border-radius:8px;background:#eef6ff;color:#1d4ed8;display:grid;place-items:center;font-weight:900;font-size:20px;border:1px solid #dbeafe}}
...
@media(max-width:680px){{.wrap{{padding:14px}}.cards,.toolbar{{grid-template-columns:1fr}}.top{{align-items:flex-start;flex-direction:column}}h1{{font-size:24px}}}}
</style>
</head>
<body>
<main class="wrap">
